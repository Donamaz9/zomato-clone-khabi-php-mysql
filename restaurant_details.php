...
<body>
	<div class="container mt-4">
		<div class="row" style="height:340px;">
        	...
        	echo '<img src="'.$row['background_img'].'"alt="img" height="100%" width="100%">'; 
        	?>
		</div>
		<div class="row navbar-static-top">
			<div class="col-8">
				...
				<p style="font-size: 18px;" class="m-0">'.$row3['category'].'</p>
				...
				for ($i = 0; $i <= $menu_length - 1; $i++)
				{
					 ...
					 while ($row1 = mysqli_fetch_assoc($result1))
					 {
						...
						<div class="col-7">
							...
							<p class="m-0 pt-2 pb-2">'."Rs.".$row1['price'].'</p>
							<small class="m-0 ">'.$row1['details'].'</small>
						</div>
						<div class="col-2">
							<a href="add_to_cartt.php?product_id='.$row1['product_id'].'" class="btn btn-outline-danger">Add</a>
						</div>
					</div>';
					 }
				} 
