...
<div class="container">
    <div class="row mt-5">
        <div class="card"style="box-shadow: 1px 1px 5px gray;width:600px; margin-left:auto;margin-right:auto;">
            ...
            <div class="card-body">
                <form action="zom_update_address.php" method="POST">
                    <?php
                    ...
                    <input type="hidden"  required name="amount" value="<?php echo $_GET['amount'] ?>">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="zom_add_address.php" method="POST">
